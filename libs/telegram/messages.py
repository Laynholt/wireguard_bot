...
ADMIN_HELP = (
    ...
    f"🖥 <b>/{BotCommand.SERVER_STATUS}</b> — загрузка процессора и память сервера\n"
    f"📈 <b>/{BotCommand.VNSTAT_WEEK}</b> — суммарный трафик за последние 7 дней (vnstat)\n"
    f"⚡ <b>/{BotCommand.SPEEDTEST}</b> — измерить скорость интернет-соединения\n\n"
